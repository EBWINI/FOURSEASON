...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "four.season", "four.season.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "four.season.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public static String  _goo() throws Exception{
 //BA.debugLineNum = 19;BA.debugLine="Sub goo";
 //BA.debugLineNum = 20;BA.debugLine="CallSubDelayed(player, \"Play\")";
anywheresoftware.b4a.keywords.Common.CallSubDelayed(processBA,(Object)(mostCurrent._player.getObject()),"Play");
